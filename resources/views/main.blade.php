            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <a href="{{ route('note.create')}}"
                       class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 font-sans dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Create your note !</a>
                    @error('deleteError')
                        <ul class='text-sm text-red-600 space-y-1'>
                            <li class='font-sans'>{{ $message }}</li>
                        </ul>
                    @enderror
                    <h2 class="mt-20 mb-5 text-xl font-bold font-sans">NOTE(S): </h2>
